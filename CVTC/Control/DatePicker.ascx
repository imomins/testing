...
<table id="tbl_control" cellspacing="0" cellpadding="0" border="0" style="border-style:none; border-width:0px; white-space: nowrap;">
	<tr>
		<td align="middle" style="border-style:none; border-width:0px; height: 30px;"><asp:textbox id="txt_Date" onclick="ValLastname()" runat="server" CssClass="txtinput" Width="200" Height ="21" onmouseover="Tip('Date of birth format should be 1/1/2001 or 01/05/2001.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()"></asp:textbox>*mm/dd/yyyy&nbsp;
		</td>
