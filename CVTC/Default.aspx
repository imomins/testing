...
*/
       ...
       var maintab = jQuery('#tabs', '#RightPane').tabs({
        ...
        //alert(st+label);
                        $.ajax({
                            ...
                            $(st, "#tabs").append('<iframe src="' + 'pg/student/' + url + '" style="width:1050px; min-height:1000px;" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0" vspace="10" hspace="0" />');
                            }
                        });
    ...
    jQuery(document).ready(function() {
      ...
      //      url: "tree.xml",
        url: 'MenuHandler.ashx',
            ...
            { name: "menu", width: 100, resizable: false, sortable: false },
                ...
                if (treedata.isLeaf == "true") {
                    ...
                    if ($(st).html() != null) {
                        maintab.tabs('select', st);
                            ...
                            if (treedata.url == 'pg/task/newTask.aspx') {                                   
                                    document.getElementById('home').contentWindow.task(); 
                                    return;
                                    }
                            else if(treedata.url=='pg/message/NewMessage.aspx'){
                                    document.getElementById('home').contentWindow.message();                                     
                                    return;
                            }                                  
                        ...
                        $.ajax({
                            ...
                            $(st, "#tabs").append('<iframe src="' + treedata.url + '" style=" width:1060px; min-height:760px;" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" />');
 ...
 function changeTabName(presenName)
{
 	
 	  $(".ui-state-active a span").replaceWith("<span>"+ presenName+"</span>");
...
<body>
    <div id="LeftPane" class="ui-layout-west ui-widget ui-widget-content">
        <div style="position: absolute; top: 24px; left: 10px; height: 25px; width: 50px;
            z-index: 999;">
            <img id="btnRefresh" alt="Refresh" src="images/refresh-icon.png" />
        </div>
        <table id="west-grid">
        </table>
    ...
    <div id="RightPane" class="ui-layout-center ui-helper-reset ui-widget-content">
        <!-- Tabs pane -->
        <div style="position: absolute; top: 10px; right: 10px; height: 25px; width: 50px;
            z-index: 999;">
            <%-- <a href="login.aspx" style="font-size:14px; color:#fff; font-weight:bold; text-decoration:none;">logout</a>--%>
            <form runat="server">
            <asp:LinkButton ID="lbtnLogOut" Style="font-size: 14px; color: #fff; font-weight: bold;
                text-decoration: none;" runat="server" OnClick="lbtnLogOut_Click">logout</asp:LinkButton>
            </form>
        </div>
        <div style="position: absolute; top: 10px; right: 100px; height: 25px; width: 50px;
            z-index: 999;">
            <asp:Label ID="LabelUserName" runat="server" Text="" Visible="False"></asp:Label>
        </div>
        <div id="switcher">
        </div>
        <div id="tabs" class="jqgtabs" style="overflow: hidden; min-height: 98%;">
            <ul>
                <li><a id="tab11" href="#tabs-1">Home </a></li>
            </ul>
            <div id="tabs-1" style="font-size: 10px; font-weight: bold; height: 1000px; width: 100%;">
                &nbsp;<br />
                <iframe id="home" src="home.aspx" style="width: 1060px; height: 980px;" scrolling="auto"
...
{
	var data = getElementsByClassName("ui-state-default ui-corner-top ui-tabs-selected ui-state-active");
