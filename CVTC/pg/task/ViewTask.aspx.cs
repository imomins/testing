...
public partial class pg_ViewTask : System.Web.UI.Page
{
    ...
    private void PopulateGridview()
    {
        ...
        { 
            ...
            GridViewTask.DataSource = task.GetAllTaskRecipientByUserOID(OID);//mess.GetMessages(numberOfRows, pageIndex, sortColumnName, sortOrderBy, out totalRecords);
