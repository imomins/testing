<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taskSent.aspx.cs" Inherits="pg_task_taskSent" %>
...
<body>
    ...
    <tr><td align="left" style=" padding:0px; margin:0px;" >
                ...
                <li><span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"> <a href="#" style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; " >Sent </a></span></li>
                <li><span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"> <a href="TaskCompleted.aspx" style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; ">Completed </a></span></li>
 ...
 <div class="ContentHolder">
        ...
        <asp:GridView ID="GridViewTask" runat="server" AutoGenerateColumns="False" CssClass="datagrid" Width="100%"
            onpageindexchanging="GridViewTask_PageIndexChanging" AllowPaging="True">
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                    <asp:CheckBox ID="CheckBoxTask" runat="server" />
                    <asp:HiddenField ID="HiddenFieldTask" runat="server" Value='<%# Bind("TaskOID") %>' />
...
<%--                <asp:TemplateField HeaderImageUrl="~/images/flag_icon.png" >
                    ...
                    <ItemTemplate>
                        <asp:Image ImageUrl="~/images/flag_icon.jpg" runat="server"/>
                    </ItemTemplate>
                </asp:TemplateField>--%>
