<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewTask.aspx.cs" Inherits="pg_ViewTask" %>
...
<body>
    ...
    <tr><td align="left" style=" padding:0px; margin:0px;" >
                ...
                <li> <span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"><a href="#" style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; ">Task </a></span></li>
        ...
        <asp:GridView ID="GridViewTask" runat="server" AutoGenerateColumns="False" CssClass="datagrid" Width="100%"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Tittle">
                    ...
                    <ItemTemplate>
                        <a href='DisplayTask.aspx?taskUOID=<%# Eval("TaskUserOID")%>&taskOID=<%# Eval("taskOID")%>&keepThis=true&TB_iframe=true&height=460&width=600'
