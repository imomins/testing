    ...
    <script type ="text/javascript" >
        function DeleteQuestion(index) {
            ...
            if (LockeAss == '1') {
                ...
                $.ajax({
                    type: "POST",
                    url: "Section.aspx/DeleteQuestion",
...
<body>
    ...
    <table width ="100%">
        ...
        <td>Group Name</td>
        <td>
            <asp:Label ID="TextBoxSectionName" runat="server"></asp:Label>&nbsp;
            <asp:Button ID="btnDeleteSection" runat="server" Text="Delete this Group" 
                Width ="150px" onclick="btnDeleteSection_Click" OnClientClick="javascript:return confirm(&quot;Are you sure you want to delete?&quot;);" />
            </td></tr>
        </table>
        </td></tr>
        <tr><td></td></tr>
        ...
        &nbsp;&nbsp;&nbsp;
         <asp:Label ID="LabelMessage" runat="server" ForeColor="#FF0066"></asp:Label>
        </div>
