<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MessageSent.aspx.cs" Inherits="pg_message_MessageSent" %>
    ...
    <table style="width: 1060px;">
        <tr>
            <td align="left" style=" padding:0px; margin:0px;">
                ...
                <li><span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"> <a href="MessageManagement.aspx" style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; ">Inbox </a></span></li>
                <li><span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"> <a href="MessageSent.aspx" style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; ">Sent </a></span></li>
                <li><span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"> <a href="MessageTrash.aspx"  style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; ">Trash </a></span></li>
                <li><span class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all ui-button-text"> <a href="NewMessage.aspx?keepThis=true&TB_iframe=true&height=460&width=800" style="font-weight:bold; padding:2px 10px 2px 10px; margin-right:5px; " class="thickbox" onunload="AfterClick();">Compose </a></span></li>                
                </ul>
        ...
        <tr>
            <td>
                ...
                <asp:GridView ID="GridViewMessageBox" runat="server" 
                    AutoGenerateColumns="False" AllowPaging="True" CssClass="datagrid" Width="100%"
                    onpageindexchanging="GridViewMessageBox_PageIndexChanging" >
                    <Columns>
                        <asp:TemplateField>
                            <EditItemTemplate>
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBoxMessage" runat="server" />
                                <asp:HiddenField ID="HiddenFieldMessage" runat="server" Value='<%# Bind("MessageOID") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
<%--                        <asp:TemplateField HeaderImageUrl="~/images/flag_icon.png">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Image ID="ImageFlgFlag" runat="server" ImageUrl=""/>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderImageUrl="~/images/StarIconGold.png">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Image ID="ImageMark" runat="server" ImageUrl='<%# Eval("MarkURL") %>'/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Subject">
                            ...
                            <a href='DisplayMessage.aspx?mid=<%# Eval("MessageOID")%>&keepThis=true&TB_iframe=true&height=460&width=800'
