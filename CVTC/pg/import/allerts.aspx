<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allerts.aspx.cs" Inherits="pg_import_allerts" %>
         ...
         <tr>
            <td>
                Uploaded file will not replace students in database, it will add to students on file.
                                           <asp:LinkButton ID="LinkButtonNTO" runat="server" 
                    onclick="LinkButtonNTO_Click" >Download Sample file</asp:LinkButton>   </td>
            ...
            <td>
                <asp:GridView ID="GridViewNTO" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Col_1" HeaderText="ALLERT" />
                    </Columns>
